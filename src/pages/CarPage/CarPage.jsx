    ...
    <>
      <div className="flex justify-center items-start py-8 px-2">
        <div className="w-full max-w-6xl relative overflow-x-auto shadow-lg rounded-xl border border-gray-200 bg-white p-6">
          <table className="w-full table-fixed text-sm text-left rtl:text-right text-gray-700 border-collapse">
            <colgroup>
              <col style={{ width: "28%" }} />
              <col style={{ width: "22%" }} />
              <col style={{ width: "18%" }} />
            ...
            <thead className="text-xs uppercase bg-gray-100 text-gray-700 text-center">
              <tr>
                <th
                  scope="col"
                  className="px-2 py-3 border-b border-gray-200 break-words"
                >
                  Nombre
                </th>
                <th
            ...
            <tbody>
              ...
              {car.map((product) => (
                ...
                >
                  <th
                    scope="row"
                    className="px-2 py-4 font-medium text-gray-900 border-b border-gray-200 break-word text-start"
                  >
                    {product.title}
                  </th>
                  <td className="px-2 py-4 border-b border-gray-200 break-words">
                    {product.category}
                  </td>
